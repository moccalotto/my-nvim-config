...
" Colours {{{1
"" General {{{2
" hi Normal       ctermfg=252 guifg=#d0d0d0 ctermbg=252 guibg=#1c1c1c cterm=none gui=none
hi Normal       ctermfg=252 guifg=#d0d0d0 ctermbg=252 guibg=#000000 cterm=none gui=none
...
hi Comment      ctermfg=244 guifg=#808080                           cterm=italic gui=italic
